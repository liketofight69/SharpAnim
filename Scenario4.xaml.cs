...
namespace SimpleImaging
{
    public sealed partial class Scenario1_Basic : Page
    {
            ...
            void Image_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            bitmapImage.UriSource = new Uri(img.BaseUri, "Images/sample.gif");
    ...
    public sealed partial class Scenario2 : Page
    {
        ...
        public static DependencyProperty AutoPlayProperty { get; }//Might nned this for my photo edits//
    ...
    public sealed partial class Scenario4 : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            // Attempt to load the previously saved scenario state.
            if (m_localSettings.ContainsKey("scenario4FileToken"))
            {
                RestoreDataFromPersistedState();
            }
        }
        ...
        private void SaveDataToPersistedState(object sender, SuspendingEventArgs args)
        {
            ...
            if (m_fileToken != null)
            {
                ...
                m_localSettings.Add("scenario4FileToken", m_fileToken);
                m_localSettings.Add("scenario4Width", m_displayWidthNonScaled);
                m_localSettings.Add("scenario4Height", m_displayHeightNonScaled);
                m_localSettings.Add("scenario4Scale", m_scaleFactor);
                m_localSettings.Add("scenario4UserRotation",
                    Helpers.ConvertToExifOrientationFlag(m_userRotation)
                    );

                m_localSettings.Add("scenario4ExifOrientation",
                    Helpers.ConvertToExifOrientationFlag(m_exifOrientation)
                    );

                m_localSettings.Add("scenario4DisableExif", m_disableExifOrientation);
        ...
        private async void RestoreDataFromPersistedState()
        {
            try
            {
                ...
                m_fileToken = (string)m_localSettings["scenario4FileToken"];
                m_displayWidthNonScaled = (uint)m_localSettings["scenario4Width"];
                m_displayHeightNonScaled = (uint)m_localSettings["scenario4Height"];
                m_scaleFactor = (double)m_localSettings["scenario4Scale"];

                PhotoOrientation desiredOrientation =
                    Helpers.ConvertToPhotoOrientation((ushort)m_localSettings["scenario4UserRotation"]);

                m_exifOrientation =
                    Helpers.ConvertToPhotoOrientation((ushort)m_localSettings["scenario4ExifOrientation"]);

                m_disableExifOrientation = (bool)m_localSettings["scenario4DisableExif"];
        ...
        private void ResetPersistedState()
        {
            m_localSettings.Remove("scenario4FileToken");
            m_localSettings.Remove("scenario4Scale");
            m_localSettings.Remove("scenario4Rotation");
            m_localSettings.Remove("scenario4Width");
            m_localSettings.Remove("scenario4Height");
            m_localSettings.Remove("scenario4UserRotation");
            m_localSettings.Remove("scenario4ExifOrientation");
            m_localSettings.Remove("scenario4DisableExif");
        }
